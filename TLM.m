...
% plotN = 50; % How often the plots are updated has been increased to 50; making the resulting plot output to appear faster
L = 1000e-6*1e2; % Length of the medium
XL = [0,L]; % Range for the z-axis
YL = [0,InputParasL.E0]; % Range for the y-axis
